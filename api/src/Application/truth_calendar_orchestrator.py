...
from Domain.TruthCalendar import Calendar
...
class TruthCalendarOrchestrator:
    ...
    def __init__(
        self,
        truth_service: IRemoteCalendarService,
        sync_service: SyncService,
    ) -> None:
        self._truth_service = truth_service
        self._sync_service = sync_service

    def get_calendar(self) -> ServiceResult[Calendar]:
        return self._truth_service.get_calendar()

    def add_event(self, event: CalendarEvent) -> ServiceResult[CalendarEvent]:
    ...
    def update_event(self, event: CalendarEvent) -> ServiceResult[CalendarEvent]:
